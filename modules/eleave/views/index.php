...
class View extends \Gcms\View
{
    ...
    public function render(Request $request, $params)
    {
        ...
        $table = new DataTable(array(
            ...
            'hideColumns' => array('id', 'start_period', 'end_date', 'end_period', 'status', 'end_hour', 'start_minutes', 'end_minutes'),
    ...
    public function onCreateFooter()
    {
        ...
        return '<tr><td></td><td class=right colspan=2>{LNG_Total}</td><td class=center>'.self::getdatstime($this->days).'</td><td></td></tr>';
    }
